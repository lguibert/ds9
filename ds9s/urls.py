...
urlpatterns = patterns('ds9s.views',
	...
	url(r'^/fits/saveReview/(?P<id>[0-9]+)/(?P<uniq_name>[0-9]+_[0-9a-z]{8}-[0-9]{4}-[0-9a-z]{4}-[0-9a-z]{4}-[0-9a-z]{12})/(?P<next_uniq_name>[0-9]+_[0-9a-z]{8}-[0-9]{4}-[0-9a-z]{4}-[0-9a-z]{4}-[0-9a-z]{12})/?$','saveUserReview'),
